const POI_BUILDER = (function() {
    ...
    // Private functions
    function setDisplayType(divPosition) {

        return (Math.abs(divPosition.x) < 4000 && Math.abs(divPosition.y) < 4000) ?
            'block' :
            'none';
    }
    ...
    function hidePopupItemsOnMobileZoom(gmap, zoomLimitSmall = 14, zoomLimitLarge = 15) {
