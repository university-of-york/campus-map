...
var selectedMode = $(".c-btn--mode").attr("id");
...
function initMap() {
    ...
    directionsDisplay.setPanel(document.getElementById('directionsTab'));
    var onChangeHandler = function() {
        ...
        $("#directionsTab  h3").text(selectedMode);
    ...
    document.getElementById('WALKING').addEventListener('change', onChangeHandler);
    document.getElementById('BICYCLING').addEventListener('change', onChangeHandler);
    ...
    myMap.controls[google.maps.ControlPosition.TOP_RIGHT].push(customControlDiv);
                    ...
                    function toggleLayer() {
                        if ($(this).is(':checked')) {
                            ...
                            map.data.addListener('click', function(event) {
                                ...
                                infowindow.setContent('<div style="width:150px;"><h3>' + title + '</h3><p>' + desc + '</p>' + '<hr><p><a href="">More information</a></p>' + '</div>');
